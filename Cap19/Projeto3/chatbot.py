...
# Chave
openai.api_key = "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"
...
def gera_texto(texto):
    ...
    response = openai.Completion.create(
        ...
        # Valores próximos a 1 significam que a saída é mais aleatória, enquanto valores próximos a 0 significam que a
